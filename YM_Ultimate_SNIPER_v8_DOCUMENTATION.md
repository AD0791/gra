...
```
⚡GOD    = GOD MODE (8.5+ score) → TAKE IT NOW, full size
...
|-------|---------------|--------|------|
| **8.5-10** | ⚡ GOD MODE | TAKE IT NOW | Full position |
| **7.0-8.4** | ⭐ EXCELLENT | High priority | 75-100% size |
| **5.0-6.9** | 🟡 MEDIUM | Standard setup | 50-75% size |
| **3.5-4.9** | 🔶 WEAK | Caution | 25-50% size |
| **<3.5** | ❌ NO SIGNAL | No trade | — |
